...
SettingsDriver.prototype.emit = SettingsDriver.prototype.trigger = function(type){
	...
	switch(args.length){
		...
		case 1:
			...
			break;
		case 2:
			return this.__emit.call(this, type, args[1]);
			break;
		case 3:
			return this.__emit.call(this, type, args[1], args[2]);
			break;
		case 4:
			return this.__emit.call(this, type, args[1], args[2], args[3]);
			break;
		// slower
		default:
			return this.__emit.apply(this, args.slice(1));
	}
